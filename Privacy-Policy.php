...
<main id="main-content">
    <div id="policy-container">
        ...
        <div id="policy-body">
            <ul>
                <li><span style="font-size:1.4em;">This Privacy Policy describes how bluenectar.co.in&nbsp;(the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</span></li>
            </ul>
            ...
            <ul>
                <li>
                    <strong>Examples of Personal Information collected:</strong>&nbsp;the version of web browser, IP address, time zone, cookie information, what sites or products you view, search terms, and how you interact with the Site.
                </li>
                <li>
            ...
            <ul>
                <li>
                    <strong>Examples of Personal Information collected:</strong> name, billing address, shipping address, payment information (including credit card numbers), email address, and phone number.
                </li>
                <li>
            ...
            <p>Gorkhapur, Utter Pradesh, India</p>
            <p>Last updated: 12th Jan, 2024</p>
            <p>If you are not satisfied with our response to your complaint, you have the right to lodge your complaint with the relevant data protection authority. You can contact your local data protection authority, or our supervisory authority here:&nbsp;<a href="https://ico.org.uk/make-a-complaint/" target="_blank">https://ico.org.uk/make-a-complaint/</a></p>
        </div>
    </div>
</main>
