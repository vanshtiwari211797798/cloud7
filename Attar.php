...
<style>
    ...
    #attar-product-image-container:hover .attar-product-image.default {
        opacity: 0;
    }

    #attar-product-image-container:hover .attar-product-image.hover {
        opacity: 1;
    }

    #attar-discount-badge {
        position: absolute;
        top: 10px;
        left: 10px;
        background: red;
    ...
    #attar-original-price {
        text-decoration: line-through;
        color: gray;
    }

    #attar-action-buttons {
        display: flex;
        gap: 10px;
        justify-content: center;
        margin-top: 10px;
...
<div id="attar-container">
    <h2 style="text-align:center;">Attar Role On</h2>
    <div id="attar-product-container">
        <!-- php code here -->
        <?php
