...
if (!isset($_POST['id'])) {
    echo "<script>alert('No product selected.'); window.location.href='Add_combo_offer.php';</script>";
    exit;
}
...
$query = "SELECT * FROM combo_offer WHERE id = ?";
...
if (!$product) {
    echo "<script>alert('Product not found.'); window.location.href='Add_combo_offer.php';</script>";
    exit;
}
...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="update_combo_post.php">
